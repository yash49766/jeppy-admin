...
function Allproducts() {
    ...
    function fetchdata() {
        axios.get("https://valin-backend.onrender.com/api/product").then((response) => setProducts(response.data)).catch((error) => console.log(error));
    }
    ...
    function handleDelete(id) {
        axios.delete(`https://valin-backend.onrender.com/api/product/${id}`).then(() => fetchdata()).catch((error) => console.log(error));
    }
                    ...
                    <Table>
                        <TableHead>
                            <TableRow sx={{backgroundColor: '#f0f0f0'}}>
                                ...
                                >
                                    <Typography noWrap sx={{ overflow: "hidden", textOverflow: "ellipsis",fontWeight: 'bold', color: '#244E54' }}>
                        ...
                        <TableBody>
                            {products.map((item, index) => (
                                <TableRow key={index + 1} sx={{'&:hover': {backgroundColor: '#f5f5f5'}}}>
                                    ...
                                    <TableCell sx={{ maxWidth: 150, overflow: "hidden", whiteSpace: "nowrap", textOverflow: "ellipsis" }}>
